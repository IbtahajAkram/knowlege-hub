  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-md p-6 bg-white shadow-2xl rounded-2xl">
        ...
        <SignUp
          redirectUrl="/dashboard" // ✅ Redirect after successful signup
          appearance={{
            elements: {
              card: "shadow-none",
              headerTitle: "text-xl font-bold",
              socialButtonsBlockButton:
                "bg-green-600 text-white hover:bg-green-700 transition w-full",
            },
          }}
        />
      </div>
...
// ```bash
// # .env.local
// NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_bWludC13YXNwLTg3LmNsZXJrLmFjY291bnRzLmRldiQ
// CLERK_SECRET_KEY=sk_test_Cj47K0bs411OlxcaxLuJZOLGXu1PHUUN6QgzvYjp9I
// ```
